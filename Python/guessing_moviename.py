# -*- coding: utf-8 -*-
"""Guessing_moviename.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wNlPGDKyR7jzOK8vXYEZTzbhINo2e4Pu
"""

points=[0,0]
turn=0
while True:
  print("player ",turn+1," will give movie name and player",(turn+1)%2+1," will guess movie")
  ...
  while(g_movie!=movie_name):
    ...
    print("Your points is ",points[turn]," and opponent point is ",points[(turn+1)%2])
  turn=(turn+1)%2
